...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('宣言投稿') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('declaration.confirm') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <input id="tag" type="text" class="form-control @error('tag') is-invalid @enderror" name="tag" value="{{ old('tag') }}" placeholder="ダグを入力してください　例：#投稿#勉強">
